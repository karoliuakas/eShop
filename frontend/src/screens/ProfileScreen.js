                    ...
                    loading ? <LoadingBox></LoadingBox> :
                        error ? <MessageBox variant="danger">{error}</MessageBox> :
                            <>
                                ...
                                { successUpdate && (<MessageBox variant="success">Profilis atnaujintas</MessageBox>)}
                                <div>
                                    <label htmlFor="nick">Vardas Pavardė</label>
                                ...
                                <div>
                                    ...
                                    <input id="confirmPassword" type="Password" onChange={(e) => setConfirmPassword(e.target.value)}></input>
                                </div>
                                <div>
                                    <label></label>
